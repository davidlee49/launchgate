...
import { b as FlagRegistry, R as Resolver, C as Context } from '../resolver-DjTGv8b9.js';
 ...
 */
declare function requestContext(extra?: Context): Promise<Context>;
/**
 ...
 *   if (gate) return gate;
 */
declare function requireFlag<T extends FlagRegistry, K extends keyof T & string>(resolver: Resolver<T>, key: K, ctx?: Context): Promise<NextResponse | null>;
