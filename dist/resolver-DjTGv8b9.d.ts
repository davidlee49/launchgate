...
interface Resolver<T extends FlagRegistry> {
    resolve<K extends keyof T & string>(key: K, ctx?: Context): Promise<FlagValueOf<T, K>>;
    readonly flags: T;
}
declare function createResolver<T extends FlagRegistry>(options: ResolverOptions<T>): Resolver<T>;

export { type Context as C, type Decision as D, type FlagMeta as F, type Resolver as R, type Source as S, type FlagValue as a, type FlagRegistry as b, type FlagValueOf as c, type FlagDef as d, type ResolverOptions as e, type SourceErrorInfo as f, createResolver as g, defineFlags as h };
